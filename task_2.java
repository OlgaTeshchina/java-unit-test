...
public void checkIsAdultWhenAgeIs18True(){
        ...
        assertEquals("Должно вернуться true т к пользователю 18 лет", true, isAdult);
        };
...
public void checkIsAdultWhenAgeIsLessThan18False(){
        ...
        assertEquals("Должно вернуться false тк пользователь младше 18 лет", false, isAdult);
        }